...
{
char [] arr={'A','H','M','E','D'};			//random characters

Task1 t=new Task1();					//object of class
System.out.print(t.linearSearch(arr, 'E'));		//print Linear search method by calling it by object of class with perameters (array and input character to be find)
