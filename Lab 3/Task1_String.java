...
{
	String [] arr={"Hasan","Ali","Areeb","Ahmed","Sameer"};		//random sring in dense array

	Task1 t=new Task1();					//creating object of class
	System.out.print(t.linearSearch(arr, "Sameer"));		//printing the method,calling it by object of class and giving perameters for input
